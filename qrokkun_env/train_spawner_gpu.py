...
# Spawner MultiDiscrete flattened: edge(4) * along(8) * aim(9) = 288
N_EDGE = 4
N_ALONG = 8
N_AIM = 9  # 0=direct at player, 1..8 = offset angles
SPAWNER_ACTIONS = N_EDGE * N_ALONG * N_AIM
SPAWNER_OBS_DIM = 8  # px,py,pvx,pvy,elapsed,spawn_acc,nbullets,speed_scale
...
def spawn_from_action(env: Qrokkun26Env, action: int) -> None:
    ...
    # Prefer medium bullets for pressure.
    kind = 1
