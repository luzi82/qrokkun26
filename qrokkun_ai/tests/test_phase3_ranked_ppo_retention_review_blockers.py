...
tools/phase3_ranked_ppo_retention.py and qrokkun_ai/agents/player_checkpoints.py.
...
from qrokkun_ai.agents.player_checkpoints import (  # noqa: E402
    file_sha256,
...
from qrokkun_ai.agents.player_v1 import OBS_DIM_V1, PlayerV1  # noqa: E402
from qrokkun_env.env import ACTIONS  # noqa: E402

from qrokkun_ai.tools import phase2_ranked_multiseed as rm  # noqa: E402
from qrokkun_ai.tools import phase3_ranked_ppo_retention as ret  # noqa: E402
from qrokkun_ai.tools.phase2_distill_v1_to_v4 import collect_dataset  # noqa: E402
...
def _rollout(rewards: list[float], dones: list[bool], values: list[float]) -> Any:
    from qrokkun_ai.agents.obs_v4 import BULLET_FEAT_V4, MAX_BULLETS_V4, PLAYER_FEAT_V4
