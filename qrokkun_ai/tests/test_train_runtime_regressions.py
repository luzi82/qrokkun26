...
from qrokkun_ai.train.player_v0 import PlayerMLP, Rollout, collect_episode
from qrokkun_ai.train.player_v1 import ActorCritic, bc_pretrain, shaped_reward
from qrokkun_ai.train.spawner_v1 import PlayerAC, player_act
...
def test_shims_still_import() -> None:
    import qrokkun_ai.train_both_v3_gpu as shim
