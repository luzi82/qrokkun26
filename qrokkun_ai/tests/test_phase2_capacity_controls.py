...
from qrokkun_ai.agents.encoder_v4 import BulletSetEncoder  # noqa: E402
...
from qrokkun_ai.agents.player_v4 import PlayerV4  # noqa: E402
from qrokkun_env.env import ACTIONS  # noqa: E402
from qrokkun_ai.tools import phase2_capacity_controls as cc  # noqa: E402
...
def test_selection_never_uses_closed_loop_survival() -> None:
    src = (_REPO_ROOT / "qrokkun_ai" / "tools" / "phase2_capacity_controls.py").read_text()
