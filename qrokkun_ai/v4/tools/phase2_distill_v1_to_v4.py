...
Teacher: PlayerV1 + qrokkun_ai.v1.obs.vectorize, loaded from --teacher (e.g.
...
from qrokkun_ai.v1.obs import OBS_DIM, vectorize
...
# --------------------------------------------------------------------------- #
# Checkpoint packing (mirrors qrokkun_ai.v4.train.checkpoints_v4 conventions)
# --------------------------------------------------------------------------- #
