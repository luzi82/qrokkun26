...
from qrokkun_ai.v4.agents.encoder_v4 import BulletSetEncoder  # noqa: E402
...
from qrokkun_ai.v4.agents.player_v4 import PlayerV4  # noqa: E402
from qrokkun_env.env import ACTIONS  # noqa: E402
from qrokkun_ai.v5.tools import phase2_capacity_controls as cc  # noqa: E402
...
def test_selection_never_uses_closed_loop_survival() -> None:
    src = (_REPO_ROOT / "qrokkun_ai" / "v5" / "tools" / "phase2_capacity_controls.py").read_text()
