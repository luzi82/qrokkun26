...
top-k Player architecture (qrokkun_ai/v5/agents/player_checkpoints.py).
...
from qrokkun_ai.v5.tests.test_player_ranked_topk import make_batch  # noqa: E402
...
def test_pack_checkpoint_carries_production_architecture_metadata():
    ...
    from qrokkun_ai.v5.agents.player_ranked_topk import ARCHITECTURE, PlayerRankedTopK
