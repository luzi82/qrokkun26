...
def test_rollout_loads_ranked_checkpoint_and_reports_fixed_censor_contract(tmp_path: Path):
    ...
    from qrokkun_ai.v5.render_player_v5_demo import FIXED_FRAME_CAP, FIXED_SEED, run_demo_rollout
...
def test_parser_accepts_seed_and_preserves_default_3000():
    from qrokkun_ai.v5.render_player_v5_demo import build_parser
...
def test_bullet_sprite_loader_uses_the_godot_kind_mapping(tmp_path: Path):
    ...
    from qrokkun_ai.v5.render_player_v5_demo import load_bullet_sprites
...
def test_bullet_sprite_loader_rejects_any_missing_required_sprite(tmp_path: Path):
    from PIL import Image
    from qrokkun_ai.v5.render_player_v5_demo import DemoRenderError, load_bullet_sprites
...
def test_render_frame_composites_preloaded_godot_bullet_sprites(tmp_path: Path):
    ...
    from qrokkun_ai.v5.render_player_v5_demo import load_bullet_sprites, render_frame
...
def test_loader_contract_rejects_wrong_architecture_and_hash_and_action_is_deterministic(tmp_path: Path):
    from qrokkun_ai.v5.agents.player_checkpoints import CheckpointArchitectureError, CheckpointSchemaError, pack_player_checkpoint
    from qrokkun_ai.v5.agents.player_ranked_topk import PlayerRankedTopK
    from qrokkun_env.env import Qrokkun26Env
    from qrokkun_ai.v5.render_player_v5_demo import deterministic_player_action, load_demo_player
...
def test_public_ranked_renderer_loader_rejects_missing_or_wrong_architecture_version(
    ...
    from qrokkun_ai.v5.agents.player_checkpoints import CheckpointSchemaError, pack_player_checkpoint
    from qrokkun_ai.v5.agents.player_ranked_topk import PlayerRankedTopK
    from qrokkun_ai.v5.render_player_v5_demo import load_demo_player
...
def test_post_step_final_frame_and_hit_vs_censor_are_unambiguous(tmp_path: Path, monkeypatch):
    ...
    from qrokkun_ai.v5.agents.player_checkpoints import load_ranked_top_k_checkpoint, save_player_checkpoint
    from qrokkun_ai.v5.agents.player_ranked_topk import PlayerRankedTopK
    from qrokkun_env.env import Bullet, Qrokkun26Env
    from qrokkun_ai.v5.render_player_v5_demo import FIXED_SEED, _run_loaded_rollout
    ...
    monkeypatch.setattr("qrokkun_ai.v5.render_player_v5_demo.FIXED_FRAME_CAP", 1)
...
def test_renderer_writes_identity_sidecar_and_refuses_any_overwrite(tmp_path: Path, monkeypatch):
    ...
    from qrokkun_ai.v5.agents.player_checkpoints import file_sha256, save_player_checkpoint, state_dict_sha256
    from qrokkun_ai.v5.agents.player_ranked_topk import PlayerRankedTopK
    from qrokkun_ai.v5.render_player_v5_demo import DemoRenderError, render_demo
    ...
    monkeypatch.setattr("qrokkun_ai.v5.render_player_v5_demo.subprocess.run", fake_ffmpeg)
...
def test_renderer_reaches_ffmpeg_with_all_repository_bullet_sprites(tmp_path: Path, monkeypatch):
    ...
    from qrokkun_ai.v5.agents.player_checkpoints import save_player_checkpoint
    from qrokkun_ai.v5.agents.player_ranked_topk import PlayerRankedTopK
    from qrokkun_ai.v5.render_player_v5_demo import render_demo
...
def test_ffmpeg_failure_is_closed_and_frame_directory_is_cleaned(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr("qrokkun_ai.v5.render_player_v5_demo.subprocess.run", failing_ffmpeg)
