...
and qrokkun_ai/v5/agents/player_checkpoints.py.
...
from qrokkun_ai.v5.agents.obs_v4 import BULLET_FEAT_V4, MAX_BULLETS_V4, PAD_RADIUS, PLAYER_FEAT_V4  # noqa: E402
...
from qrokkun_ai.v1.obs import OBS_DIM  # noqa: E402
from qrokkun_ai.v5.tools import phase2_ranked_multiseed as rm  # noqa: E402
from qrokkun_ai.v4.tools.phase2_distill_v1_to_v4 import Frame  # noqa: E402
...
def test_evaluate_aggregate_gate_honors_args_held_agreement_min(tmp_path: Path) -> None:
    from qrokkun_ai.v5.tests.test_phase2_ranked_multiseed import _seed_report
...
def test_pack_player_checkpoint_records_runtime_provenance() -> None:
    from qrokkun_ai.v5.agents import player_checkpoints as pc
...
def test_quick_cli_end_to_end_with_real_teacher_checkpoint(tmp_path: Path) -> None:
    ...
    cmd = [
        sys.executable,
        "-m",
        "qrokkun_ai.v5.tools.phase2_ranked_multiseed",
        "--teacher",
        str(teacher_path),
        "--out-dir",
        str(out_dir),
