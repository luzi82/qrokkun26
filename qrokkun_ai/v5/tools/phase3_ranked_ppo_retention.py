...
Run from the repository root with::
    ...
    PYTHONPATH=. python -m qrokkun_ai.v5.tools.phase3_ranked_ppo_retention \
...
# CLI defaults (qrokkun_ai/v1/train/player_v1.py), never reinvented.
# --------------------------------------------------------------------------- #
PPO_LR = 3e-4
PPO_GAMMA = 0.99
PPO_LAMBDA = 0.95
...
def load_initial_checkpoint(
    ...
    Delegates to :mod:`qrokkun_ai.v5.agents.player_checkpoints`, which refuses
