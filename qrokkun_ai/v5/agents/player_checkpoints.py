...
Only the ranked top-k architecture (:mod:`qrokkun_ai.v5.agents.player_ranked_topk`)
...
from qrokkun_ai.v5.agents.player_ranked_topk import ARCHITECTURE_VERSION as RANKED_TOP_K_ARCHITECTURE_VERSION
