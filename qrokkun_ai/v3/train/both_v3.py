...
Canonical nets: agents.player_v3 + agents.spawner_v3 (PlayerAC/SpawnerAC aliases).
"""
...
from qrokkun_ai.v3.obs_rich import OBS_DIM_RICH, vectorize_rich
from qrokkun_env.policies import FleeNearestBullet
from qrokkun_ai.v3.agents.player_v3 import PlayerV3
from qrokkun_ai.v3.agents.spawner_v3 import (
    SPAWNER_ACTIONS,
    SpawnerV3,
    decode_spawner,
    spawn_from_action,
...
OBS_DIM = OBS_DIM_RICH
# Canonical aliases — training loop must use agents classes (not local duplicates).
PlayerAC = PlayerV3
SpawnerAC = SpawnerV3
